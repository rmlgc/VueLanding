  ...
  <div class="social-header header-btns">
    ...
    <div class="header-socials">
      <a href="about:blank" class="social-link" target="_blank" rel="noopener noreferrer">
        <img class="social-icon" src="https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/linktree-logo-icon.png">
      </a>
      <a href="about:blank" class="social-link" target="_blank" rel="noopener noreferrer">
        <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="32" data-view-component="true" class="octicon octicon-mark-github social-icon">
