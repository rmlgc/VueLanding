...
<template>
  <section class="aboutMe">
    ...
    <p class="text-body2">
      <br />
      I have a 3 year career as a 'web developer' && <span class="inline-block">2 years of learning progress by my own
        projects</span>
    </p>
    <hr>
        ...
        <div class="accordion-content">
          <p>
            <small>
              ...
              learning is rewarding(<a href="#resumeFrontend" :class="`bg-glass active`">BackEnd</a>)
            </small>
          </p>
        </div>
      </div>
